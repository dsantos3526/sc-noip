#!/bin/bash
#Open HTTP Puncher By www.sundanese.ml
...
cd 
wget -O /usr/local/bin/ohp "https://github.com/jhoy-id/sc-noip/raw/main/ohp"
...
Documentation=https://t.me/BokirTampan
